...
/**
 * @author xuzhuowei ²éÑ¯Ìõ¼þBean
 */
public class AccountCondition implements KvmSerializable {
	...
	public AccountCondition(Date startDate, Date endDate) {
		this.startDate = Format.DateStr.getDate(startDate);
		this.startDate = Format.DateStr.getDate(endDate);
		currentLanguage = Env.GetCurrentLanguage().trim();
	}

	public AccountCondition(String starDate, String endDate) {
