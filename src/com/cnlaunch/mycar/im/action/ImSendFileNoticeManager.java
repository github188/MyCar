...
public class ImSendFileNoticeManager {
	...
	public ImSendFileNoticeManager(Context context, int id) {
		mContext = context;
		mNoticeId = id;
	...
	public void setupNotice() {
		...
		String noticeContent = mContext.getResources().getString(R.string.im_send_file);
	...
	public void updateNotice(String noticeContent, boolean isOnGoing) {
		...
		mNotification.setLatestEventInfo(mContext,  mContext.getResources().getString(R.string.im_send_file), noticeContent,
				mContentIntent);
