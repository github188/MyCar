...
public class DestClientAddFriendReceiver extends LetterReceiver {

	private final int mId = ImConstant.Reciver.SERVER_DEST_ACK_ADD_FRIEND;
	private Context mContext;

	public DestClientAddFriendReceiver(Context context) {
		mContext = context;
	}
	...
	public void dealLetter(ILetter letter) {
		...
		// 被添加者，收到信封后，取出添加者的信息，并写入好友列表
		IMMyFriendComModel model = imAddFriendComModel.getSourceUserComModel();
