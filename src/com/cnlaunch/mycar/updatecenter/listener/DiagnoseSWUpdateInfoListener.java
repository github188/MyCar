...
public class DiagnoseSWUpdateInfoListener implements WebServiceListener 
{
    ProgressDialog pdlg;
    DiagnoseSWUpdateInfoListener thiz = this;
    ...
    Handler handler;
    Resources resources;
    public DiagnoseSWUpdateInfoListener(Activity activity, 
        Handler handler,
        HttpDownloadManager httpDownloader,
        DefaultHttpListener downloadListener,
        WebServiceOperator webservice)
