...
public class DiagnoseSWDownloadListener extends DefaultHttpListener
{
    ...
    Activity activity;
    Handler handler;
    public DiagnoseSWDownloadListener(Activity activity, Handler handler,HttpDownloadManager httpDownloader)
    {
