 ...
 * Original file: D:\\work\\MyCarAndroid\\Code\\src\\com\\cnlaunch\\mycar\\gps\\service\\IGpsLoggerServiceRemote.aidl
 */
package com.cnlaunch.mycar.gps.service;
public interface IGpsLoggerServiceRemote extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote
{
private static final java.lang.String DESCRIPTOR = "com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote";
...
/**
 * Cast an IBinder object into an com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote interface,
 * generating a proxy if needed.
 */
public static com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote))) {
return ((com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote)iin);
}
return new com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote.Stub.Proxy(obj);
}
...
private static class Proxy implements com.cnlaunch.mycar.gps.service.IGpsLoggerServiceRemote
{
...
public long getTrackId() throws android.os.RemoteException
{
...
static final int TRANSACTION_getTrackId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_loggingState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_startLogging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_pauseLogging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_resumeLogging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_stopLogging = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_storeMediaUri = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_isMediaPrepared = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_storeDerivedDataSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getLastWaypoint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
}
public long getTrackId() throws android.os.RemoteException;
public int loggingState() throws android.os.RemoteException;
public long startLogging() throws android.os.RemoteException;
